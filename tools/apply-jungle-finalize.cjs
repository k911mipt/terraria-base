...
required("JG_HUB_LANTERN_L").x = 24;
required("JG_HUB_LANTERN_L").lightRadius = 12;
required("JG_HUB_LANTERN_L").desc =
  "Подвесной Jungle Lantern находится между левой стойкой и шахтой студии; над ним сплошной потолок y22.";
required("JG_HUB_LANTERN_R").x = 36;
required("JG_HUB_LANTERN_R").lightRadius = 12;
required("JG_HUB_LANTERN_R").desc =
  "Второй фонарь висит слева от правой живой стойки и освещает резерв поверхностного телепортера.";
...
check = check.replace(
  "solid.x1 <= 52 && solid.x2 >= 8 && solid.y1 === 35",
...
console.log("Finalized Jungle outpost geometry, lighting and navigation.");
