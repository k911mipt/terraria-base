...
показывает диагностику повреждённой записи. Полный контракт предметов и регистрация
рендереров остаются в #27; геометрия и игровые имена этой проверкой не подтверждаются.
...
Точные команды запуска и все десять Node checker-ов перечислены в [README](../README.md#проверки).
