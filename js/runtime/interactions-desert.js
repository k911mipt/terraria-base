...
document.getElementById("craft").onclick = () => focusRect(25, 26, 62, 35, 2);
document.getElementById("arena").onclick = () => focusRect(25, 26, 62, 52, 2);
document.getElementById("pitsBtn").onclick = () => focusRect(58, 26, 70, 70, 2);
