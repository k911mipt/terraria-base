// Apply this scene's palette/specification extensions to a fresh materials record.
export function extendMaterials(materials) {
  const { MAT, WALL, STYLE, BLOCK_SPECS, WALL_SPECS } = materials;
