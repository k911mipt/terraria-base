...
Проверка реального HTTP-запуска всех четырёх сцен, desktop/mobile-взаимодействий и
отрицательных мутаций: [установка, команда и артефакты](docs/browser-tests.md).
После установки test-only зависимостей:
